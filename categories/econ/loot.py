...
# Define items that will not be multiplied by multiplying potions.
PREVENT_MULTIPLY = (
    "shulker_box",
    "streak_freezer",
    "mushroom",
...
# Define the base maximum amount of items per slot can the extra slot hold. For each shulker that exceed MAX_SHULKER_EFFECT, a SAFE_CAPACITY_PER_EXTRA_SHULKER multiplier will add towards the total items.
MAX_SAFE_CAPACITY_BASE = 50
SAFE_CAPACITY_PER_EXTRA_SHULKER = 10
...
__EXPLORE_LOOT = {
    "5 (Overworld)": {
        "stone_sword": {
            ...
            "chicken": RewardRNG(rate = 1, min_amount = 1, max_amount = 2),
        ...
        "iron_sword": {
            ...
            "chicken": RewardRNG(rate = 1, min_amount = 1, max_amount = 4),
            "raw_damage": RewardRNG(rate = 0.5, min_amount = 1, max_amount = 2),
        },
        "diamond_sword": {
            "rotten_flesh": RewardRNG(rate = 0.5, min_amount = 3, max_amount = 5),
            "meat": RewardRNG(rate = 1, min_amount = 1, max_amount = 5),
            "bacon": RewardRNG(rate = 1, min_amount = 1, max_amount = 5),
            "chicken": RewardRNG(rate = 1, min_amount = 1, max_amount = 5),
            "raw_damage": RewardRNG(rate = 0.5, min_amount = 1, max_amount = 2),
        },
        "nether_sword": {
            "rotten_flesh": RewardRNG(rate = 0.5, min_amount = 3, max_amount = 5),
            "meat": RewardRNG(rate = 1, min_amount = 1, max_amount = 6),
            "bacon": RewardRNG(rate = 1, min_amount = 1, max_amount = 6),
            "chicken": RewardRNG(rate = 1, min_amount = 1, max_amount = 6),
            "raw_damage": RewardRNG(rate = 0.5, min_amount = 1, max_amount = 2),
        },
        "fragile_star_sword": {
            "rotten_flesh": RewardRNG(rate = 0.75, min_amount = 4, max_amount = 6),
            "meat": RewardRNG(rate = 1, min_amount = 1, max_amount = 7),
            "bacon": RewardRNG(rate = 1, min_amount = 1, max_amount = 7),
            "chicken": RewardRNG(rate = 1, min_amount = 1, max_amount = 7),
            "raw_damage": RewardRNG(rate = 0.5, min_amount = 1, max_amount = 2),
        },
    },
    "4 (Overworld)": {
    ...
    "Bastion Remnant (Nether)": {
        ...
        "diamond_sword": {
            ...
            "magma_cream": RewardRNG(rate = 0.25, min_amount = 7, max_amount = 10),
            "meat": RewardRNG(rate = 0.25, min_amount = 8, max_amount = 12),
        ...
        "fragile_star_sword": {
            ...
            "meat": RewardRNG(rate = 0.375, min_amount = 10, max_amount = 14),
    ...
    "Hidden Shrine (Nether)": {
        ...
        "diamond_sword": {
            "rotten_flesh": RewardRNG(rate = 1, min_amount = 1, max_amount = 48),
            "gold": RewardRNG(rate = 1, min_amount = 1, max_amount = 30),
            "magma_cream": RewardRNG(rate = 1, min_amount = 1, max_amount = 30),
            "gunpowder": RewardRNG(rate = 1, min_amount = 1, max_amount = 15),
            "pearl": RewardRNG(rate = 1, min_amount = 1, max_amount = 20),
            "blaze_rod": RewardRNG(rate = 1, min_amount = 1, max_amount = 10),
        ...
        "fragile_star_sword": {
            "rotten_flesh": RewardRNG(rate = 1, min_amount = 1, max_amount = 58),
            "gold": RewardRNG(rate = 1, min_amount = 1, max_amount = 36),
            "magma_cream": RewardRNG(rate = 1, min_amount = 1, max_amount = 36),
            "gunpowder": RewardRNG(rate = 1, min_amount = 1, max_amount = 18),
            "pearl": RewardRNG(rate = 1, min_amount = 1, max_amount = 24),
            "blaze_rod": RewardRNG(rate = 1, min_amount = 1, max_amount = 12),
...
__CHOP_LOOT = {
    "Forest (Overworld)": {
        "stone_axe": {
            ...
            "apple": RewardRNG(rate = 1, min_amount = 1, max_amount = 4),
            "orange": RewardRNG(rate = 1, min_amount = 1, max_amount = 4),
            "cherries": RewardRNG(rate = 1, min_amount = 1, max_amount = 6),
            "carrot": RewardRNG(rate = 0.5, min_amount = 1, max_amount = 4),
        ...
        "iron_axe": {
            ...
            "apple": RewardRNG(rate = 1, min_amount = 2, max_amount = 4),
            "orange": RewardRNG(rate = 1, min_amount = 2, max_amount = 4),
            "cherries": RewardRNG(rate = 1, min_amount = 3, max_amount = 6),
            "carrot": RewardRNG(rate = 0.5, min_amount = 2, max_amount = 4),
        ...
        "diamond_axe": {
            ...
            "apple": RewardRNG(rate = 1, min_amount = 3, max_amount = 6),
            "orange": RewardRNG(rate = 1, min_amount = 3, max_amount = 6),
            "cherries": RewardRNG(rate = 1, min_amount = 5, max_amount = 10),
            "carrot": RewardRNG(rate = 0.5, min_amount = 3, max_amount = 6),
        ...
        "fragile_star_axe": {
            ...
            "apple": RewardRNG(rate = 1, min_amount = 3, max_amount = 7),
            "orange": RewardRNG(rate = 1, min_amount = 3, max_amount = 7),
            "cherries": RewardRNG(rate = 1, min_amount = 6, max_amount = 12),
            "carrot": RewardRNG(rate = 0.75, min_amount = 3, max_amount = 7),
    ...
    "Village (Overworld)": {
        "stone_axe": {
            "wood": RewardRNG(rate = 1, min_amount = 1, max_amount = 3),
            "apple": RewardRNG(rate = 1, min_amount = 1, max_amount = 3),
            "orange": RewardRNG(rate = 1, min_amount = 1, max_amount = 3),
            "cherries": RewardRNG(rate = 1, min_amount = 1, max_amount = 4),
            "carrot": RewardRNG(rate = 0.5, min_amount = 1, max_amount = 3),
        ...
        "fragile_star_axe": {
            ...
            "carrot": RewardRNG(rate = 0.75, min_amount = 1, max_amount = 3),
    ...
    "Crimson Forest (Nether)": {
        ...
        "fragile_star_axe": {
            ...
            "dry_leaf": RewardRNG(rate = 1, min_amount = 300, max_amount = 360),
...
def get_activity_loot(action_type: str, equipment_id: str, location: str, external_buffs: t.Sequence[str] = None) -> dict[str, int] | None:
...
def get_craft_recipe(item_id: str) -> dict[str, int] | None:
...
def get_brew_recipe(potion_id: str) -> dict[str, int] | None:
